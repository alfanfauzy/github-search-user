...
function App() {
  ...
  const { data: ListUser, isLoading } = useGetUsersListViewModal(searchValue, {
    enabled: searchValue !== "",
  });
  ...
  return (
    <div className="bg-slate-200 h-screen w-screen text-black py-4 px-4">
      <div className="pt-10 m-auto h-[calc(100vh-2rem)] w-[500px] border mx-auto shadow-md bg-white px-5 rounded-xl flex flex-col">
